...
For the later independent check of a public clone, see
[8 September public release status](PUBLIC_RELEASE_STATUS.md). The successful
local SQL-dependent run below is an upstream report, not a result reproducible
from the public source tree alone.
