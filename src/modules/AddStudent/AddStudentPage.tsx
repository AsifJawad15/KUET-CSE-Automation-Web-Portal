          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  <label className="block text-sm font-medium text-[#5D4E37] dark:text-white/70 mb-1">Email (Optional)</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#5D4E37] dark:text-white/70 mb-1">Section</label>
                  <select
              ...
              <div className="flex gap-3 pt-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="flex-1 px-4 py-2 bg-gradient-to-r from-[#D9A299] to-[#DCC5B2] text-white rounded-full"
                >
                  Add Student
                </motion.button>
              </div>
            ...
            <table className="w-full">
              <thead className="bg-[#F0E4D3] dark:bg-[#060010]/50 border-b border-[#DCC5B2] dark:border-[#392e4e]">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-[#5D4E37] dark:text-white/60 uppercase">Batch</th>
                  <th className="px-6 py-4 text-left text-xs font-semibold text-[#5D4E37] dark:text-white/60 uppercase">Section</th>
                  <th className="px-6 py-4 text-left text-xs font-semibold text-[#5D4E37] dark:text-white/60 uppercase">Year-Term</th>
              ...
              <tbody className="divide-y divide-[#DCC5B2]/50 dark:divide-[#392e4e]/50">
                {filteredStudents.map((student, index) => (
                  ...
                  >
                    <td className="px-6 py-4 font-medium text-[#5D4E37] dark:text-white">{student.roll}</td>
                    <td className="px-6 py-4 text-[#5D4E37] dark:text-white">{student.name}</td>
                    <td className="px-6 py-4 text-[#8B7355] dark:text-white/60">{student.email}</td>
                    ...
                    <td className="px-6 py-4 text-[#8B7355] dark:text-white/60">{student.section}</td>
                    <td className="px-6 py-4 text-[#8B7355] dark:text-white/60">{student.currentYear}-{student.currentTerm}</td>
                    <td className="px-6 py-4">
